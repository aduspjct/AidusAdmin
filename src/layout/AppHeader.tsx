...
export default function AppHeader() {
  ...
  return (
    <header className="sticky top-0 z-99999 flex w-full flex-col border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900 lg:flex-row lg:border-b">
      <div className="flex flex-col grow items-center justify-between lg:flex-row lg:items-stretch lg:justify-between lg:px-6">
        <div className="flex h-16 w-full shrink-0 items-center justify-between border-b border-gray-200 px-4 dark:border-gray-800 sm:px-5 lg:w-auto lg:justify-normal lg:border-b-0 lg:px-0">
          <button
