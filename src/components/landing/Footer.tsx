  ...
  return (
    <footer className="footer">
        ...
        <div className="footer-grid">
          ...
          <div>
            ...
            <p className="footer-subtitle">
              Trusted platform to book verified home service professionals anytime, anywhere.
            </p>
          ...
          <div>
            ...
            <ul>
              <li>
                <a href="#" className="footer-link">Cancellation & Refund Policy</a>
              </li>
              <li>
                <a
                  href="/privacy-policy"
            ...
            <ul>
              <li className="footer-contact-item">
                <img
                  ...
                  alt="Email"
                  className="footer-contact-icon footer-icon-blue"
                />
      ...
      <div className="footer-copyright">
        <p>© 2025 Aidus App. All rights reserved.</p>
      </div>
    </footer>
  );
}
